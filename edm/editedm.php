...
<body>
<form name="form1" method="post" action="saveeditedm.php">
<p>&nbsp;</p>
     <p>&nbsp;</p>
     <p>&nbsp;</p>
     <p>&nbsp; </p>
...
<div class="span3 offset3 well">
	...
	<legend align="center"  > <b> แก้ไข EDM ตามกลุ่มเป้าหมาย</b></legend>
      ...
      <label for="txtSMS">ข้อความ EDM :</label>
      <textarea class="form-control" rows="5" name="txtEDM" id="txtEDM" cols="45" rows="5" placeholder="ระบุรายละเอียดหัวข้อ EDM ใหม่"></textarea><p>
